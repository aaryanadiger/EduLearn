...
These Terms and Conditions govern the use of the EduLearn website. By accessing or using the website, you agree to follow these terms.

1. Acceptance of Terms
By using EduLearn, you agree to comply with these Terms and Conditions. If you do not agree with any part of these terms, please do not use the website.

2. Use of the Website
Users agree to use the website responsibly and only for lawful purposes.
Users must not:
...
All content on the EduLearn platform, including text, graphics, logos, and educational materials, is the property of EduLearn unless stated otherwise.
Users may not copy, distribute, or reproduce website content without permission.

4. User Accounts
If users create an account on the platform:
• They are responsible for keeping their login credentials secure
• They are responsible for all activities under their account
EduLearn reserves the right to suspend or terminate accounts that violate these terms.

5. Educational Content Disclaimer
All educational materials on the platform are provided for learning purposes only. EduLearn does not guarantee specific results or outcomes from using the content.

6. Limitation of Liability
EduLearn will not be responsible for any direct or indirect damages arising from the use of the website or its services.

7. Termination
We reserve the right to suspend or terminate user access if the terms are violated.

8. Governing Law
These Terms and Conditions are governed by the laws of India.

9. Changes to Terms
EduLearn may update these Terms and Conditions at any time. Continued use of the website after updates means users accept the new terms.`;

const PRIVACY_CONTENT = `PRIVACY POLICY
Last Updated: March 11, 2026

Welcome to EduLearn. Your privacy is important to us. This Privacy Policy explains how we collect, use, and protect your information when you use our website and services.

1. Information We Collect
We may collect different types of information when you use our website.
...
Cookies
We may use cookies and similar technologies to improve user experience and analyze website traffic.
...
• Improve learning content and user experience

3. Sharing of Information
We do not sell or rent personal information to third parties.
Information may only be shared with:
• Trusted service providers that help operate the website
• Legal authorities if required by law
• Security services to protect the platform

4. Data Security
We take reasonable measures to protect your personal information from unauthorized access, misuse, or disclosure. However, no online platform can guarantee complete security.

5. Third-Party Services
Our website may use third-party services such as analytics tools, hosting providers, or learning integrations. These services may collect their own data according to their privacy policies.

6. Children's Privacy
EduLearn is intended for educational purposes. If we discover that personal information from a child has been collected without proper consent, we will remove it as soon as possible.
                                ...
                                <div className="space-y-4 pt-4 border-t border-neutral-800">
                                    <div className="flex items-start gap-3 text-sm">
                                        ...
                                        <label htmlFor="terms" className="text-neutral-400 cursor-pointer select-none leading-relaxed">
                                            I agree to the <button type="button" onClick={() => setModalConfig({ isOpen: true, title: "Terms and Conditions", content: TERMS_CONTENT })} className="text-white hover:text-accent transition-colors underline decoration-neutral-700 underline-offset-4">Terms of Service</button> and <button type="button" onClick={() => setModalConfig({ isOpen: true, title: "Privacy Policy", content: PRIVACY_CONTENT })} className="text-white hover:text-accent transition-colors underline decoration-neutral-700 underline-offset-4">Privacy Policy</button>
                                        </label>
                                    </div>
