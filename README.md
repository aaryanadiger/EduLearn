...
EduLearn is a modern, full-stack education platform built with Next.js 16, React 19, and Firebase. It delivers an interactive learning ecosystem featuring courses, live classes, AI-powered learning assistance, and comprehensive dashboards for students, faculty, and administrators.
...
3. **Set up environment variables**
   ...
   Obtain your Firebase config from **Firebase Console > Project Settings > General > Your Apps**.
...
│   │   ├── dashboard/      # Student, Faculty, and Admin dashboards
